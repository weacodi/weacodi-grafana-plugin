...
All weather data is provided by [Open-Meteo](https://open-meteo.com/en/docs), a free, no-auth weather API. The WeaCoDi core service adds caching, unit conversion and derived fields on top of the raw Open-Meteo forecast.

## Need help?

For support or feature ideas reach out to Oleksii Zubovskyi & Olena Zubovska (<mailto:weacodi@gmail.com>) or open an issue in the repository.
